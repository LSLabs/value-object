...
use LSLabs\ValueObject\AbstractCompositeValueObject;
...
class AbstractCompositeValueObjectTest extends TestCase
{
    ...
    public function test_isNull_ON_all_child_value_objects_are_null_RETURNS_true(): void
    {
        ...
        $primitives->a = $this->createMock(AbstractValueObject::class);
    ...
    public function test_isSame_ON_identical_toArray_RETURNS_true(): void
    {
        ...
        $primitives->b = $this->createMock(AbstractCompositeValueObject::class);
        $primitives->b->method('toArray')->willReturn($array['b']);
        $stack = CompositeValueObject::fromPrimitive($primitives);

        $mock = $this->createMock(AbstractCompositeValueObject::class);
...
class CompositeValueObject extends AbstractCompositeValueObject
{
    protected $a;
    ...
    private function __construct(
        ValueObjectInterface $a,
        ValueObjectInterface $b
    )
    {
        $this->a = $a;
        $this->b = $b;
